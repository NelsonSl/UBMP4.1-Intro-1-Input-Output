...
Next, try pressing and holding SW4 while pressing and releasing SW3. Does it
...
The pitch of the tone does not change when the delay value is made smaller.
...
The tones would combine and make a new tone
...
When both buttons are pressed LED D4 does stay on but the light is dimmer compared to when only SW3 is pressed. The light appears to be dimmer because when both buttons are pressed it’ll give it a rapid change in values from 0 and 1 and the light will flicker so fast the light just appears to be dimmer but when in reality it turns on and off too fast for our eyes to handle.
